...
from lab.cfgs.robots.hebi.robot_cfg import FRAME_EE
...
class HebiDCMotorHebi_JointPos_GoalTracking_Env(IdealPDHebi_JointPos_GoalTracking_Env):
    def __post_init__(self):
        super().__post_init__()
        self.scene: ObjectSceneCfg = HebiDCMotorHebi_ObjectSceneCfg(num_envs=1, env_spacing=2.5, replicate_physics=False)
