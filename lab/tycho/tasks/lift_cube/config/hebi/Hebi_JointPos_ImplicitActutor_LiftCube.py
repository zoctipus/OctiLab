...
class RewardsCfg(SceneRewardsCfg, RobotRewardsCfg):
    ...
    reward_object_ee_distance = RewTerm(func=lift_cube_mdp.reward_object_ee_distance, params={
        "object_cfg": SceneEntityCfg("object"),
        "fixed_chop_frame_cfg": SceneEntityCfg("frame_free_chop_tip"),
        "free_chop_frame_cfg": SceneEntityCfg("frame_free_chop_tip")}, weight=1.0)
