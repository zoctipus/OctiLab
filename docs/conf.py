...
html_title = "Octi Lab documentation"
...
html_theme_options = {
    ...
    "use_sidenotes": True,
    "logo": {
        "text": "Octi Lab documentation",
        "image_light": "source/_static/OCTI-NVIDIA-logo.png",
        "image_dark": "source/_static/OCTI-NVIDIA-logo.png",
    },
    "icon_links": [
        {
            "name": "GitHub",
