...
def position_in_robot_root_frame(env: OctiManagerBasedRLEnv, position_b: str) -> torch.Tensor:
    """The position of the object in the robot's root frame."""
...
def end_effector_speed(env: OctiManagerBasedRLEnv, end_effector_speed_str: str) -> torch.Tensor:
    """The position of the object in the robot's root frame."""
