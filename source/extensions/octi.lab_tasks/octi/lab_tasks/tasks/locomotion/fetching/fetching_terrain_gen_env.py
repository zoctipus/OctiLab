...
from octi.lab.terrains.terrain_importer_cfg import MultiOriginTerrainImporterCfg
...
# Pre-defined configs
##
from octi.lab.terrains.config.rough import TERRAINS_GEN_CFG, TERRAINS_GEN_PLAYGROUND_CFG  # isort: skip
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    # ground terrain
    terrain = MultiOriginTerrainImporterCfg(
        prim_path="/World/ground",
        terrain_type="generator",
        terrain_generator=TERRAINS_GEN_PLAYGROUND_CFG,
...
class EventCfg:
    ...
    reset_origin = EventTerm(
        func=mdp.reset_origin,
        mode="reset",
        params={
            "multi_origin_terrain": SceneEntityCfg("terrain"),
        },
    )
