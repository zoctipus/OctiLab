...
def try_to_close_reward(
    env: OctiManagerBasedRLEnv,
    canberry_eeframe_distance_key: str,
    chop_tips_canberry_cos_angle_key: str,
    chop_pose_key: str,
):
    canberry_eeframe_distance = env.data_manager.get_active_term("data", canberry_eeframe_distance_key)
...
def miss_penalty(env: OctiManagerBasedRLEnv, canberry_eeframe_distance_key: str, chop_pose_key: str):
    canberry_eeframe_distance = env.data_manager.get_active_term("data", canberry_eeframe_distance_key)
...
def chop_action_rate_l2(env: OctiManagerBasedRLEnv) -> torch.Tensor:
...
def lift_reward(env: OctiManagerBasedRLEnv, canberry_height_key: str, canberry_grasp_mask_key: str):
...
def canberry_cake_distance_reward(
    env: OctiManagerBasedRLEnv, canberry_cake_distance_key: str, canberry_height_key: str, canberry_grasp_mask_key: str
):
...
def try_to_drop_reward(env: OctiManagerBasedRLEnv, canberry_cake_distance_key: str, chop_pose_key: str):
