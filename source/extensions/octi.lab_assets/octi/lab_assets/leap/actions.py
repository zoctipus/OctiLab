...
LEAP_JOINT_POSITION: JointPositionActionCfg = JointPositionActionCfg(asset_name="robot", joint_names=["j.*"], scale=1)


LEAP_JOINT_EFFORT: JointEffortActionCfg = JointEffortActionCfg(asset_name="robot", joint_names=["j.*"], scale=0.1)
