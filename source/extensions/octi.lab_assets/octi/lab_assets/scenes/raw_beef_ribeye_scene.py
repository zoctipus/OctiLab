...
from octi.lab.assets import DeformableCfg
...
class SceneObjectSceneCfg(InteractiveSceneCfg):
    ...
    wooden_board: AssetBaseCfg = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(-0.3308790688293063, -0.459486269649666, -3.4006016153006077e-7), rot=(0.70711, 0.0, 0.0, 0.70711)
        ),
        spawn=UsdFileCfg(
    ...
    wagyu: AssetBaseCfg = DeformableCfg(
        ...
        init_state=DeformableCfg.InitialStateCfg(
            pos=(-0.3128404333733237, -0.45898978548773034, 0.013707292356420923),
    ...
    cast_iron_skillet: AssetBaseCfg = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(-0.5131438058661296, -0.3138202611064712, 0.02727337380958563), rot=(1, 0.0, 0.0, 0.0)
        ),
        spawn=UsdFileCfg(
    ...
    rosemary1: AssetBaseCfg = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=(-0.3046810561276882, -0.5766609175208751, 0.01000015711686957), rot=(0.6594, 0.6594, 0.25534, 0.25534)
        ),
        spawn=UsdFileCfg(
    ...
    table: AssetBaseCfg = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=(-0.24571, -0.01515, -0.77), rot=(0.70711, 0.0, 0.0, -0.70711)),
        spawn=UsdFileCfg(
